              ...
              <div className="form-row">
                <div className="form-col">
                  ...
                  {errors.address && touched.address && (
                    <p className="cmnt-errors">{errors.address}</p>
                  )}
                </div>
                <div className="form-col">
                  ...
                  {errors.contactno && touched.contactno && (
                    <p className="cmnt-errors">{errors.contactno}</p>
                  )}
                </div>
              </div>
              <div className="form-row">
                <div className="form-col">
                  ...
                  {errors.country && touched.country && (
                    <p className="cmnt-errors">{errors.country}</p>
                  )}
                </div>
                <div className="form-col">
                  <label>City</label>
                  ...
                  {errors.city && touched.city && (
                    <p className="cmnt-errors">{errors.city}</p>
                  )}
                </div>
              </div>
              <div className="form-row">
                <div className="form-col">
                  ...
                  {errors.state && touched.state && (
                    <p className="cmnt-errors">{errors.state}</p>
                  )}
                </div>
                <div className="form-col">
                  ...
                  {errors.zipcode && touched.zipcode && (
                    <p className="cmnt-errors">{errors.zipcode}</p>
                  )}
                </div>
              </div>
              <div className="note">
              ...
              <div className="right-box">
                ...
                <div className="payment">
                  ...
                  <div className="payment-mathod">
                    <div
                      className={isActive === "1" ? "active" : "pay-card"}
                      id={"1"}
                      key={1}
                      onClick={handleClick}
                    >
                    ...
                    <div
                      className={isActive === "2" ? "active" : "pay-card"}
                      id={"2"}
                      key={2}
                      onClick={handleClick}
                    >
                    ...
                    <div
                      className={isActive === "3" ? "active" : "pay-card"}
                      id={"3"}
                      key={3}
                      onClick={handleClick}
                    >
